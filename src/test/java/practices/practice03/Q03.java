...
public class Q03 extends TestBase {
    ...
    public void test() {
       ...
       // Click on the "Delete" button 20 times
        ...
        System.out.println("Delet Button Before Delete = " + deleteButtonList .size()); //100
        for(int i=0; i<20; i++){
        ...
        System.out.println("Delet Button Before Delete = " + deleteButtonListAfterDelete.size()); //80

        // Assert that 20 buttons were deleted.
        assertEquals(deleteButtonList.size()-20,deleteButtonListAfterDelete.size());
      //  assertEquals(deleteButtonList.size(),deleteButtonListAfterDelete.size()+20); sout yapmadan da yapabiliriz assert
